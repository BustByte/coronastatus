...
export const countrySpecificTexts: CountrySpecificTexts = {
  ...
  LINK_TO_NATIONAL_HEALTH_SERVICES: 'https://covid19bilgi.saglik.gov.tr/tr/', // If you don't know where to link, use https://who.int
  TWITTER_NAME: 'coronastatusTR' // Remove this line if you don't have set up a Twitter account
};
