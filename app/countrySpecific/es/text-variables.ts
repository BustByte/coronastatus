...
export const countrySpecificTexts: CountrySpecificTexts = {
  ...
  LINK_TO_NATIONAL_HEALTH_SERVICES:
    'https://www.mscbs.gob.es/profesionales/saludPublica/ccayes/alertasActual/nCov-China/home.htm', // If you don't know where to link, use https://who.int
  TWITTER_NAME: 'coronastatusES' // Remove this line if you don't have set up a Twitter account
};
