...
export const countrySpecificTexts: CountrySpecificTexts = {
  ...
  LINK_TO_NATIONAL_HEALTH_SERVICES: 'www.covid19.go.id', // If you don't know where to link, use https://who.int
  TWITTER_NAME: 'coronastatusID' // Remove this line if you don't have set up a Twitter account
};
