...
export const countrySpecificTexts: CountrySpecificTexts = {
  ...
  LINK_TO_NATIONAL_HEALTH_SERVICES: 'www.gob.mx/salud', // If you don't know where to link, use https://who.int
  TWITTER_NAME: 'coronastatusMX' // Remove this line if you don't have set up a Twitter account
};
